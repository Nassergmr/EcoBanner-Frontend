...
export default function Hero() {
  return (
    <div
      id="hero_container"
      className="flex flex-col lg:flex-row gap-y-10 justify-between sm:mt-[200px] mt-[150px] sm:px-5 px-1 items-center "
    >
      <div id="content" className="text-center lg:text-left w-full lg:w-[60%]">
